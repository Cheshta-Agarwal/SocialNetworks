...
import { navigationSections } from '../../data/siteContent'
...
function AppShell({ children }: AppShellProps) {
  ...
  async function handleLoadSample() {
    try {
      ...
      alert('Unable to load sample graph.')
    }
  }
                    ...
                    <div className="mt-2 ml-2 space-y-2">
                      {section.heading === 'Tools' && (
                        <div className="ml-2 mt-2 space-y-2">
                          ...
                          <button
                            onClick={handleClear}
                            className={linkBaseClass + ' w-full justify-start text-red-300 hover:text-red-200'}
                          >
